...
REM
REM Generated by Vivado on Fri Jun 12 15:05:28 +0200 2026
...
echo "xvhdl --incr --relax -prj tb_ema_cascade_vhdl.prj"
call xvhdl  --incr --relax -prj tb_ema_cascade_vhdl.prj -log xvhdl.log
